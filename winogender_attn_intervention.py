...
def get_interventions_winogender(gpt2_version, do_filter, stat, device='cuda', filter_quantile=0.25):
...
def intervene_attention(gpt2_version, do_filter, stat, device='cuda', filter_quantile=0.25):
    interventions = get_interventions_winogender(gpt2_version, do_filter, stat, device, filter_quantile)
